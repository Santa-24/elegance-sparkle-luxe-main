    ...
    <SiteLayout>
      ...
      <section className="marble-bg py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 lg:grid-cols-2 lg:px-10">
          ...
          <div>
            ...
            <div className="text-sm font-medium text-[var(--purple-deep)]">
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {bulletPoints.slice(0, 3).map((point) => (
                ...
                >
                  <div className="font-display text-2xl font-bold gradient-gold-text">•</div>
      ...
      <section className="bg-background py-20">
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="mb-12 text-center">
            ...
            <h2 className="mt-2 font-display text-4xl text-[var(--royal)] md:text-5xl">
              Learn from the <span className="gradient-gold-text italic">best</span>
            </h2>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={c.t} className="tilt-card gold-border p-7">
                ...
                <div className="mt-4 font-display text-xl font-bold gradient-gold-text">{c.p}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="relative mx-auto max-w-5xl px-5 text-marble lg:px-10">
          <div className="mb-12 text-center">
            <div className="text-xs uppercase tracking-[0.4em] text-[var(--gold)]">Our Journey</div>
          ...
          <div className="relative space-y-10 border-l-2 border-[var(--gold)]/40 pl-8">
            {[
              ...
              <div key={year} className="relative">
                ...
                <div className="font-display text-2xl text-[var(--gold)]">{year}</div>
      ...
      <section className="bg-background py-20">
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="mb-12 text-center">
            ...
            <h2 className="mt-2 font-display text-4xl text-[var(--royal)] md:text-5xl">
              Meet the <span className="gradient-gold-text italic">artists</span>
            </h2>
            <div className="gold-divider" />
          </div>
